...
def Run_extract_reads_for_smallchunks_all(out_dir,phase_cut_folder,h5_folder,sample_name,fastq_folder,chr_start,chr_end,num_threads):
    count = 1
    ...
    for key, val in run_list.items():
        ...
        for chr_num in val:
            phased_h5_file = phase_cut_folder + "chr" + str(chr_num) + ".phased_final"
            ...
            if os.path.exists(output_dir):
                ...
                os.makedirs(output_dir)
<<<<<<< HEAD
            pool.apply_async(Extract_start,(output_dir,chr_num,phased_h5_file,mole_qname_dict_file,chr_fastq,"xin"))
=======
        ...
        """
>>>>>>> 5d48b1908cb6a183dc43b5671a30f0dae49f845b
        pool.close()
...
if __name__ == "__main__":
    ...
    Run_extract_reads_for_smallchunks_all(out_dir,phase_cut_folder,h5_folder,sample_name,fastq_folder,chr_start,chr_end,num_threads)
